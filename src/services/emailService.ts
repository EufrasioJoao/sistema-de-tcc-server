...
function createWelcomeEmailTemplate(
  ...
  return {
    subject: "Bem-vindo ao Sistema de Gestão de TCCs!",
    body: `
      <html>
        <head>
          <style>
        ...
        <body>
          <div class="container">
            ...
            <p>Sua conta no Sistema de Gestão de TCCs foi criada com sucesso. Abaixo estão suas credenciais de acesso:</p>
...
function createResetCodeTemplate(name: string, code: string) {
  return {
    subject: "Sistema de Gestão de TCCs - Recuperação de Senha",
    body: `
      <html>
        <head>
          <style>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>Sistema de Gestão de TCCs &copy; ${new Date().getFullYear()}</p>
